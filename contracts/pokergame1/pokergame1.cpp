...
void sanity_check(action_name act) {
    char buffer[32];
    ...
    for (int cnt = 0; cnt < 1; cnt++) {
        ...
        eosio_assert(a.account == N(eosvegasjack), "Invalid request!");
